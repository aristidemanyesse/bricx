...
<div class="modal inmodal fade" id="modal-useressource">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title">Nouvelle sortie de ressources</h4>
                ...
                <div class="col-md-8">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5 class="text-uppercase">Les ressources de la sortie</h5>
                        </div>
                        <div class="ibox-content"><br>
                            <div class="table-responsive">
                                <table class="table  table-striped">
                                    <tbody class="useressource">
                                        <!-- rempli en Ajax -->
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="text-center">
                                <?php foreach (Home\RESSOURCE::isActives() as $key => $ressource) { ?>
                                    <button class="btn btn-white dim newressource btn-sm" data-id="<?= $ressource->id ?>" ><?= $ressource->name(); ?></button>
                                <?php }  ?>
                            </div>
                ...
                <div class="col-md-4 ">
                    <div class="ibox"  style="background-color: #eee">
                        ...
                        <div class="ibox-content"  style="background-color: #fafafa">
                            ...
                            <hr/>
                            <button onclick="validerUseRessource()" class="btn btn-primary btn-block dim"><i class="fa fa-check"></i> Confirmer la sortie</button>
                        </div>
                    </div>
