    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
          ...
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-9">
                <h2 class="text-uppercase text-blue gras">Productions & rangements sur chantier</h2>
            </div>
            <div class="col-sm-3">
                <button style="margin-top: 5%" data-toggle="modal" data-target="#modal-production" onclick=" modification('productionchantier', <?= $production->id; ?>)" class="btn btn-success pull-right dim"><i class="fa fa-plus"></i> Production du jour</button>
            </div>
        </div>
                    ...
                    <table class="footable table table-stripped toggle-arrow-tiny">
                        ...
                        <tbody>
                            <?php foreach ($encours as $key => $production) {
                                ...
                                $lots = $production->fourni("ligneproductionchantier");
                                ?>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <?php foreach ($production->ligneproductionchantiers as $key => $ligne) { ?>
                                                        <th class="text-center " style="color: #ccc"><?= $ligne->quantite ?></th>
                                                    <?php } ?>
                                                </tr>
                                                ...
                                                <?php if ($production->etat_id == Home\ETAT::VALIDEE) { ?>
                                                    <tr>
                                                        ...
                                                        <?php foreach ($production->ligneproductionchantiers as $key => $ligne) { ?>
                                                            <th class="text-center"><?= $ligne->quantite - $ligne->perte ?></th>
                                                        <?php } ?>
                                                    </tr>
