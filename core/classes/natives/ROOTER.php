...
class ROOTER extends PATH
{
    ...
    const SECTION_ADMIN = ["manager", "master", "boutique", "entrepot", "config", "chantier"];
    ...
    public function render(){
        ...
        $date1 = dateAjoute(-3);
        $date2 = dateAjoute();
        $nbdays = dateDiffe(dateAjoute(), $mycompte->expired);
                                    ...
                                    if (in_array($role->id, $tableauDeRoles)) {
                                        ...
                                        if (count($datas) == 1) {
                                            ...
                                            if (in_array($role->id, $tableauDeRoles)) {
                                                ...
                                                $employe->actualise();
                                                session("agence_connecte_id", $employe->agence_id);


                                                if (in_array($this->section, ["boutique", "entrepot"]) && $employe->agence_id == null) {
