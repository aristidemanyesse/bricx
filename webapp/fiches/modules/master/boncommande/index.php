                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 text-right">
                                        <h2 class="title text-uppercase gras text-blue">COMMANDE</h2>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <h5><span>Lieu de livraison :</span> <span class="text-uppercase"><?= $commande->lieu ?></span></h5>                                      </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="border">
                                                <td colspan="3" class="text-uppercase text-right"><h4 class=" text-<?= ($commande->montant -$commande->avance > 0) ? "warning":"muted"  ?> ">reste à payer pour cette commande = </h4></td>
                                                <td></td>
                                                <td colspan="1" class="text-center"><h3 class="gras text-<?= ($commande->montant -$commande->avance > 0) ? "warning":"muted"  ?>"><?= money($commande->montant - $commande->avance) ?> <?= $params->devise ?></h3></td>
                                            </tr>
