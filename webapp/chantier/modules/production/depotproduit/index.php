    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
          ...
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-9">
                <h2 class="text-uppercase text-green gras">Dépôt de briques</h2>
            </div>
        </div>
        ...
        <div class="wrapper wrapper-content">
            <div class="ibox">
                <div class="ibox-title">
                    <h5>Tous les dépôts de briques effectués</h5>
                        ...
                        <tbody>
                         <?php foreach ($encours as $key => $depot) {
                            ...
                            <tr style="border-bottom: 2px solid black">
                                ...
                                <td>
                                    <span class="text-uppercase gras">Dépôt de produits</span><br>
...
foreach ($encours as $key => $depot) {
    if ($depot->etat_id == Home\ETAT::ENCOURS) { 
        include($this->rootPath("composants/assets/modals/modal-depotproduit1.php"));
    } 
} 
?>
