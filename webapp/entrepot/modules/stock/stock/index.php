          ...
          <div class="ibox">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                     <button style="margin-top: -3%;" type="button" data-toggle=modal data-target='#modal-perteproduit' class="btn btn-danger btn-xs dim"><i class="fa fa-trash"></i> Enregistrer une perte </button>
                </div>
            </div>
