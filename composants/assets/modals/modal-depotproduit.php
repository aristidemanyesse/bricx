                        ...
                        <div class="ibox-content"><br>
                            ...
                            <div class=" text-center">
                                <?php foreach (Home\PRODUIT::isActives() as $key => $item) {
                                    $item->actualise();  ?>
                                    <button class="btn btn-white dim newproduit2 text-capitalize" data-id="<?= $item->id ?>"><i class="fa fa-cube"></i> <?= $item->name(); ?></button>                   
                                <?php  } ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 ">
                    <div class="ibox"  style="background-color: #eee">
                        ...
                        <div class="ibox-content"  style="background-color: #fafafa">
                            ...
                            <hr/>
                            <button onclick="depotproduit()" class="btn btn-primary btn-block dim"><i class="fa fa-check"></i> Valider la sortie</button>
                        </div>
                    </div>
