 ...
 * 
 */
class INITIALRESSOURCECHANTIER extends TABLE
{
	...
	public function sentenseUpdate(){
		return $this->sentense = "Modification du stock initial de ressource : ".$this->ressource->name()." dans ".$this->chantier->name();
	}
