                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7 text-right">
                                            <h2 class="title text-uppercase gras text-blue">Bon d'achat de briques</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <h5><span>Fournisseur :</span> <span class="text-uppercase"><?= $appro->fournisseurchantier->name() ?></span></h5>                       
                                        </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($appro->ligneapprochantierproduits as $key => $ligne) {
                                                ...
                                                <tr>
                                                    <td class="desc">
                                                        ...
                                                        <small><?= $ligne->produit->comment ?></small>
                                                    </td>
                                                    <td></td>
                                                    ...
                                                    <td class="text-center">
                                                        <h3 class="gras mp0"> <small>x</small> <?= start0($ligne->quantite) ?></h3>
                                                    </td>
                                            ...
                                            <tr class="border">
                                                <td colspan="3" class="text-right">
                                                    ...
                                                    <?php if ($appro->reglementfournisseurchantier_id == 0) { ?>
                                                        <small>Réglement par prélèvement sur acompte</small>
                                                    <?php }else{ ?>
                                                        <small>Réglement par <?= $appro->reglementfournisseurchantier->modepayement->name() ?></small>
                                                    <?php } ?>
                                            ...
                                            <tr class="border">
                                                <td colspan="3" class="text-uppercase text-right"><h4 class=" text-<?= ($appro->reste > 0) ? "warning":"muted"  ?> ">reste <?= ($appro->reglementfournisseurchantier_id == null && $appro->reste == 0 ) ? "dans le compte":"à payer pour cette commande"  ?> = </h4></td>
                                                <td></td>
