    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
          ...
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-9">
                <h2 class="text-uppercase text-green gras">Dépôt de materiels</h2>
            </div>
        </div>
        ...
        <div class="wrapper wrapper-content">
            <div class="ibox">
                <div class="ibox-title">
                    <h5>Tous les dépôts de materiels effectués</h5>
                    ...
                    <table class="footable table table-stripped toggle-arrow-tiny">
                        ...
                        <tbody>
                         <?php foreach ($encours as $key => $depot) {
                            $depot->actualise(); 
                            $lots = $depot->fourni("lignedepotmateriel");
                            ?>
                            <tr style="border-bottom: 2px solid black">
                                ...
                                <td>
                                    <span class="text-uppercase gras">Dépôt de materiels</span><br>
                                ...
                                <td class="border-right">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr class="no">
                                                <th></th>
                                                <?php foreach ($depot->lignedepotmateriels as $key => $ligne) {
                                                    $ligne->actualise(); ?>
                                                    <th class="text-center" style="padding: 2px">
                                                        <span class="small"><?= $ligne->materiel->name() ?></span>
                                                    </th>
                                                <?php } ?>
                                            </tr>
                                        </thead>
                                ...
                                <td>
                                    <a href="<?= $this->url("fiches", "master", "bondepotmateriel", $depot->id) ?>" target="_blank" class="btn btn-white btn-sm"><i class="fa fa-file-text text-blue"></i></a>
                                    ...
                                    <?php if ($employe->isAutoriser("modifier-supprimer") && $depot->etat_id != Home\ETAT::ANNULEE) { ?>
                                        <button onclick="annuler('depotmateriel', <?= $depot->id ?>)" class="btn btn-white btn-sm"><i class="fa fa-trash text-red"></i></button>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php  } ?>
...
foreach ($encours as $key => $depot) {
    if ($depot->etat_id == Home\ETAT::ENCOURS) { 
        include($this->rootPath("composants/assets/modals/modal-depotmateriel1.php"));
    } 
} 
?>
