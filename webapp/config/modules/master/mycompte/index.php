                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6 col-12">
                                    <div class="ibox ">
                                        ...
                                        <div class="ibox-content">
                                            <h2 class="no-margins"><?= start0(count(Home\PRODUIT::getAll()))  ?></h2>
    ...
    <div class="modal-dialog modal-xll">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <small class="font-bold">Plus d'information sur <a href="https://www.devaris21.pro/abonnement/" target="_blank">https://www.devaris21.pro/abonnement/</a></small>
            </div>
