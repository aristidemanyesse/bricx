    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">images du chantier</h4>
                <small class="font-bold">Renseigner ces champs pour enregistrer les informations</small>
            </div>
            <form method="POST" class="formShamman" classname="imagechantier">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <label>Donner un nom au image</label>
