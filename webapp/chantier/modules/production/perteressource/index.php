    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-9">
                    <h2 class="text-uppercase text-red gras">Les pertes de ressources</h2>
                    <div class="container">
                    </div>
                </div>
                <div class="col-sm-3 text-right">
                    <button style="margin-top: 5%;" type="button" data-toggle=modal data-target='#modal-perteressource' class="btn btn-danger btn-xs dim"><i class="fa fa-trash"></i> Enregistrer une perte </button>
               </div>
           </div>
                            ...
                            <?php foreach ($datas as $key => $perte) {
                                ...
                                <tr style="border-bottom: 2px solid black">
                                    ...
                                    <td>
                                        ...
                                        <button onclick="annuler('pertechantierressource', <?= $perte->id ?>)" class="btn btn-white btn-sm"><i class="fa fa-trash text-red"></i></button>
                                    <?php } ?>
                                    </td>
                                </tr>
                            <?php  } ?>
...
<?php include($this->rootPath("composants/assets/modals/modal-perteressource.php")); ?>
