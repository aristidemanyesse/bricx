<div class="modal inmodal fade" id="modal-reglerApproEtiquette<?= $appro->id  ?>">
        ...
        <div class="modal-content">
            ...
            <form method="POST" class="formShamman" classname="reglementfournisseur">
                ...
                <div class="container">
                    ...
                    <input type="hidden" name="approetiquette_id" value="<?= $appro->id ?>">
                    <input type="hidden" name="classe" value="approetiquette">
