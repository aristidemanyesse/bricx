                                                                ...
                                                                <tbody>
                                                                    <?php foreach ($encours as $key => $groupe) {
                                                                        ...
                                                                        <tr style="border-bottom: 2px solid black">
                                                                            ...
                                                                            <td>
                                                                                <small class="text-uppercase gras">Commande (<?= count($groupe->fourni("commande")) ?>)</small><br>
                                                                                <small><?= depuis($groupe->created) ?></small>
                                                                                <?php if (count($datas1) > 0) { ?>
                                                                                    <p class="text-blue">(<?= count($datas1) ?>) livraison(s) en cours pour cette commande</p>
                                                                                <?php } ?>
                                                                            </td>
                                                                            <td>le <?= datecourt($com->datelivraison) ?></td>
                                                                            <td>
                                                                                <h5 class="gras text-orange"><?= money($groupe->resteAPayer()) ?> <?= $params->devise  ?></h5>
                                                                            </td>                                                            
                                                                            <td>
                                                                                <div class="social-action dropdown" style="margin-top: 0%">
                                                                                    ...
                                                                                    <ul class="dropdown-menu">
                                                                                        ...
                                                                                        <li class="text-green" onclick="fairenewcommande(<?= $groupe->id ?>)"><a style="padding: 3px" href="#"><i class="fa fa-plus"></i> Lui ajouter commande</a></li>
                                                                                        <li class="" onclick="changement(<?= $groupe->id ?>)"><a style="padding: 3px" href="#"><i class="fa fa-history"></i> convertir les produits</a></li>
                                                                                        <li class="border"></li>
                                                                                        <li class="text-green" onclick="fichecommande(<?= $groupe->id  ?>)"><a style="padding: 3px" href="#"><i class="fa fa-eye"></i> Voir les détails</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                    ...
                    <div class="ibox selected">
                      ...
                      <div class="ibox-content">
                        <div class="tab-content">
                          ...
                          <div>
                            <?php Native\BINDING::html("select-tableau", $agence->fourni("client"), $client, "id") ?>
                        </div><hr>
