...
<div class="modal inmodal fade" id="modal-approchantierressource" style="z-index: 99999999">
    <div class="modal-dialog modal-xl" style="width: 95%">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title">Nouvel approvisionnement de ressource</h4>
                    ...
                    <div class="ibox-content"><br>
                        <div class="table-responsive">
                            ...
                            <div class=" text-center">
                                <?php foreach (Home\RESSOURCE::getAll() as $key => $item) {
                                    $item->actualise();
                                    if ($item->isActive()) { ?>
                                        <button class="btn btn-white dim newressource text-capitalize" data-id="<?= $item->id ?>"><i class="fa fa-cubes"></i> <?= $item->name(); ?></button>                   
                                    <?php  }
                                }  ?>
                            </div>
                        </div>
