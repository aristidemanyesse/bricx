                    ...
                    <tbody>
                        <tr>
                            <?php foreach ($fournisseurs as $key => $fournisseur) { ?>
                                ...
                                <td>
                                    <a><h5 class="text-uppercase gras "><?= $fournisseur->name()  ?></h5></a>
                                ...
                                <td class="text-right">
                                    <a href="<?= $this->url("entrepot", "production", "fournisseur", $fournisseur->id)  ?>" class="btn btn-white btn-xs"><i class="fa fa-eye"></i> Voir le compte</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
