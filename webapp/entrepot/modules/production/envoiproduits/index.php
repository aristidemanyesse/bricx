    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
          ...
          <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-3">
                <button style="margin-top: 5%;" type="button" data-toggle=modal data-target='#modal-envoibrique' class="btn btn-primary btn-sm dim float-right"><i class="fa fa-plus"></i> Nouvel envoi </button>
            </div>
        </div>
...
<?php include($this->rootPath("composants/assets/modals/modal-envoibrique.php")); ?>
