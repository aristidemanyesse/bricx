    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-9">
                    <h2 class="text-uppercase gras">Utilisation de Ressource</h2>
                    <div class="container">
                    </div>
                </div>
                <div class="col-sm-3 text-right">
                    <button style="margin-top: 5%;" type="button" data-toggle=modal data-target='#modal-useressource' class="btn btn-primary btn-xs dim"><i class="fa fa-plus"></i> Nouvelle sortie de ressources </button>
                </div>
            </div>
            ...
            <div class="wrapper wrapper-content">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>Toutes les sorties de ressources sur ce chantier</h5>
                        ...
                        <table class="footable table table-stripped toggle-arrow-tiny">
                            <thead>
                                <tr>
                                    ...
                                    <th data-hide="all">Ressources</th>
                                    ...
                                    <tr style="border-bottom: 2px solid black">
                                        ...
                                        <td class="border-right">
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr class="no">
                                                        <th></th>
                                                        <?php foreach ($use->ligneuseressources as $key => $ligne) {
                                                            $ligne->actualise(); ?>
                                                            <th class="text-center" style="padding: 2px">
                                                                <img style="height: 20px" src="<?= $this->stockage("images", "ressources", $ligne->ressource->image) ?>" >
                                        ...
                                        <td>
                                            <?php if ($employe->isAutoriser("modifier-supprimer") && $use->etat_id != Home\ETAT::ANNULEE) { ?>
                                                <button onclick="annuler('pertechantierressource', <?= $use->id ?>)" class="btn btn-white btn-sm"><i class="fa fa-trash text-red"></i></button>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php  } ?>
...
<?php include($this->rootPath("composants/assets/modals/modal-useressource.php")); ?>
