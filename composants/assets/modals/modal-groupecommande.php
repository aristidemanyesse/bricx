                    ...
                    <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <?php foreach ($datas as $key => $ligne) {
                                    ...
                                    <th class="text-center" style="padding: 2px">
                                        ...
                                        <span class="small"><?= $produit->name() ?></span>
                                    </th>
                                <?php } ?>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            foreach ($lots as $key => $ligne) { ?>
                                <tr>
                                    ...
                                    <td data-toggle="tooltip" title="imprimer le bon de <?= $ligne->type ?>">
                                        <?php if ($ligne->type == "Livraison") { ?>
                                            ...
                                            <td class="text-center">
                                                <?php if ($ligne->type == "commande" && $ligne->reste() > 0) { ?>
                                                    <div class=" col-md">
                                    ...
                                    <tr>
                                        ...
                                        <?php foreach ($datas as $key => $lig) { ?>
                                            <td widtd="90" class="text-center"><h2 class="gras"><?= money($groupecommande->reste($lig->produit_id)) ?></h2></td>
                                        <?php } ?>
                                    </tr>
                                </tbody>
                            </table><br><hr>
                            ...
                            <div class="row text-center" style="font-size: 12px">
                                ...
                                <?php if ($groupecommande->etat_id == Home\ETAT::ENCOURS) { ?>
                                    <div class=" col-md">
