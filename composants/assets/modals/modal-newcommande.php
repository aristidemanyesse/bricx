                    ...
                    <div class="ibox"  style="background-color: #eee">
                        ...
                        <div class="ibox-content"  style="background-color: #fafafa">
                            <form id="formCommande">
                                ...
                                <div>
                                    <label>Lieu exact de livraison <span style="color: red">*</span> </label>
                                    <div class="input-group">
                            ...
                            <h4><span>Montant brut</span> <span class="pull-right montant">0 Fcfa </span></h4>
                            <h5><span>TVA (<?= $params->tva ?> %)</span> <span class="pull-right tva">0 Fcfa </span></h5><br>
