                                    ...
                                    <tr style="border-bottom: 2px solid black">
                                        ...
                                        <td class="border-right">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr class="no">
                                                        <td><h4 class="mp0">Qté à livrer: </h4></td>
                                                        <?php foreach ($livraison->lignelivraisons as $key => $ligne) { ?>
                                                            <td class="text-center"><?= start0($ligne->quantite) ?></td>
                                                        <?php   } ?>
                                                    </tr>
                                                    <tr class="no">
                                                        <td><h4 class="mp0">Surplus: </h4></td>
                                                        <?php foreach ($livraison->lignelivraisons as $key => $ligne) { ?>
                                                            <td class="text-center"><?= start0($ligne->surplus) ?></td>
                                                        <?php   } ?>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <tr style="border-bottom: 2px solid black">
                                        ...
                                        <td class="border-right">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr class="no">
                                                        <td><h4 class="mp0">Qté livrée: </h4></td>
                                                        <?php foreach ($livraison->lignelivraisons as $key => $ligne) { ?>
                                                            <td class="text-center"><?= start0($ligne->quantite) ?></td>
                                                        <?php   } ?>
                                                    </tr>
                                                    ...
                                                    <tr class="no">
                                                        <td><h4 class="mp0">Qté reçue: </h4></td>
                                                        <?php foreach ($livraison->lignelivraisons as $key => $ligne) { ?>
                                                            <td class="text-center"><?= start0($ligne->quantite_livree) ?></td>
                                                        <?php   } ?>
                                                    </tr>
                                                    <tr class="no">
                                                        <td><h4 class="mp0">Perte: </h4></td>
                                                        <?php foreach ($livraison->lignelivraisons as $key => $ligne) { ?>
                                                            <td class="text-center text-red"><?= start0($ligne->perte) ?></td>
                                                        <?php   } ?>
                                                    </tr>
                                                </tbody>
                                            </table>
