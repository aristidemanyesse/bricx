...
<div class="modal inmodal fade" id="modal-reglerAchatMateriel<?= $appro->id  ?>">
        ...
        <div class="modal-content">
            ...
            <form method="POST" class="formShamman" classname="reglementfournisseurchantier">
                ...
                <div class="container">
                    ...
                    <input type="hidden" name="classe" value="approchantiermateriel">
                    <input type="hidden" name="approchantiermateriel_id" value="<?= $appro->id ?>">
                    ...
                    <input type="hidden" name="comment" value="Recouvrement d'achat de Materiels N°<?= $appro->reference ?>">
