    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
          ...
          <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-3">
                <button style="margin-top: 5%" data-toggle="modal" data-target="#modal-production" onclick=" modification('production', <?= $production->id; ?>)" class="btn btn-success pull-right dim"><i class="fa fa-plus"></i> Production du jour</button>
            </div>
        </div>
