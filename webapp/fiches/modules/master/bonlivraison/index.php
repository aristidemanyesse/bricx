                    ...
                    <div class="ibox"  >
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                ...
                                <h5><span>Véhicule de livraison :</span> <span class="text-uppercase"><?= $livraison->vehicule->name() ?></span></h5>      
                                <h5><span>Chauffeur :</span> <span class="text-uppercase"><?= $livraison->chauffeur() ?></span></h5>   
                            </div>
                        </div><br><br>
                        ...
                        <table class="table table-bordered">
                            <thead class="text-uppercase" style="background-color: #dfdfdf">
                                <tr>
                                    ...
                                    <th class="text-center text-red" width="120">perte</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($livraison->lignelivraisons as $key => $ligne) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <h3 class="gras mp0"><?= start0($ligne->surplus) ?></h3>
                                        </td>
                                        <td class="text-center"><h2 class="gras"><?= ($livraison->etat_id == Home\ETAT::VALIDEE) ?start0(money($ligne->quantite_livree)): "" ?></h2></td>
                                        <td class="text-center text-red"><br><h3><?= ($livraison->etat_id == Home\ETAT::VALIDEE) ? start0($ligne->perte) : "" ?></h3></td>
                                    </tr>
                                <?php } ?>                            
                            </tbody>
                        </table>
